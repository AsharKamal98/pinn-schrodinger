...
class tiSchrodingerI(torch.nn.Module):
    ...
    def loss(self, x):
        ...
        loss_norm = torch.exp(loss_norm_exp_factor * (norm - 1.0)**2) - 1.0

        return loss_pde_factor*loss_pde + loss_bc_factor*loss_bc + loss_norm_factor*loss_norm